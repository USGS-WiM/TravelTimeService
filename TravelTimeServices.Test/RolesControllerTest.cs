...
using TravelTimeServices.Controllers;
...
namespace TravelTimeServices.Test
{
    public class TravelTimeTest
    {
        public TravelTimeController controller { get; private set; }
        public TravelTimeTest() {
            //Arrange
            controller = new TravelTimeController(new InMemoryTravelTimeAgent());
    ...
    public class InMemoryTravelTimeAgent : ITravelTimeAgent
    {

        public List<Message> Messages => throw new NotImplementedException();

        public InMemoryTravelTimeAgent()
        {
